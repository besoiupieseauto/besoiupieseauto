            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="nav navbar-nav">
                        <!--<li class="{{ Request::is('/') || Request::is('orders') ? 'active' : '' }}">
                            <a href="/"><i class='glyphicon glyphicon-list-alt'></i> Comenzi TM</a>
                        </li>
                        <li class="{{ Request::is('/order-utvin') || Request::is('/create?type=utvin') || Request::is('orders/utvin*') ? 'active' : '' }}">
                            <a href="/orders/utvin"><i class='glyphicon glyphicon-list-alt'></i> Comenzi UTVIN</a>
                        </li>-->
						...
						@if (Auth::user()->hasPermission('ultilizatori'))
							<li class="{{ request()->routeIs('utilizatori*') ? 'active' : '' }}">
								<a href="{{ route('utilizatori.index') }}"><i class='glyphicon glyphicon-user'></i> Utilizatori</a>
							</li>
						@endif
