                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}" style="margin-top: 10%;">
                                @csrf
                                <a href="javascript:void(0);" onclick="event.preventDefault(); this.closest('form').submit();" style="color: #777777; text-decoration: none;margin-right: 7px; font-size: 14px;">
