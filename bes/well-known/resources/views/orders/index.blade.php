...
@section('title', 'Comenzi Timisoara')
@section('head')
<style>
    .datepicker {
        top: 165px !important;
        ...
        <div class="panel panel-info">
			...
			<div class="form-horizontal">
                <div class="row" style="margin-top: 0.3%;">
					...
					<div class="length-control text-right">
                    ...
                    if(index == 'produs') {
                        ...
                        if (divElement) {
                            ...
                            if(attributeValue == 1) {
                                ...
                                //$('td', row).eq(5).attr('style', 'background-color: ' + background + ' !important; color: ' + color + ' !important;vertical-align: top;');
                            }
                            else {
