...
final class ScraperImageSourcesSync
{
    ...
    public static function internalSourceTemplates(): array
    {
        return [
            'produse_db' => [
                'label' => 'Magazin / import review (deja scanat)',
                'roles' => ['image'],
                'categories' => ['*'],
            ],
            'caietcomenzi' => [
            ...
            'local_ttc_poze' => [
                'label' => 'Bibliotecă locală Poze (TTC_ART_ID)',
                'roles' => ['image'],
                'categories' => ['*'],
            ],
            'autopartner_local' => [
                'label' => 'Bibliotecă locală Autopartner',
                'roles' => ['image'],
                'categories' => ['*'],
            ],
            'tecdoc_csv' => [
...
PHP;
    ...
    private static function writeOverlay(array $integration): void
    {
        ...
        $overlay = [
            'image_plans' => ScraperIntegrationSchema::dedupePlansBySource(
                array_values(array_filter((array) ($integration['image_plans'] ?? []), 'is_array'))
            ),
