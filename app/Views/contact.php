...
<head>
    ...
    besoiu_render_seo_meta(besoiu_seo_page_meta('/contact', $contactPage, 'website'));
    ?>
...
<section class="ct-hero">
    <div class="container">
        ...
        <div class="ct-visual">
            <div class="ct-blob">
                <span class="ct-blob-icon"><i class="fa-solid fa-phone" aria-hidden="true"></i></span>
            </div>
            ...
            <div class="ct-float-card ct-fc<?= $index + 1 ?>">
                <div class="fc-icon"><i class="fa-solid <?= site_cms_h($cardIcon) ?>" aria-hidden="true"></i></div>
...
<div class="ct-strip">
    <div class="ct-strip-inner">
        ...
        <div class="ct-strip-item">
            <div class="si-icon"><i class="fa-solid <?= site_cms_h($stripIcon) ?>" aria-hidden="true"></i></div>
    ...
    <div class="container">
        <div class="ct-form-section">
            ...
            <form class="ct-form" id="contact-form">
                ...
                <button type="submit" class="ct-submit" id="contact-form-submit"><?= site_cms_h($contactBlocks['form']['submit'] ?? 'TRIMITE MESAJUL') ?> <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></button>

                <div class="ct-privacy"><i class="fa-solid fa-lock" aria-hidden="true"></i> <?= site_cms_h($contactBlocks['form']['privacy'] ?? '') ?></div>
            ...
            <ul class="ct-faq">
                ...
                <li class="ct-faq-item<?= $index === 0 ? ' open' : '' ?>">
                    <div class="ct-faq-q">
                        ...
                        <span class="ct-faq-toggle"><i class="fa-solid fa-plus" aria-hidden="true"></i></span>
                    </div>
    ...
    <div class="container">
        <div class="ct-cta-inner">
            ...
            <div class="ct-cta-card">
                <div class="ct-cta-icon"><i class="fa-solid <?= site_cms_h($ctaCard['icon'] ?? 'fa-phone') ?>" aria-hidden="true"></i></div>
                <strong><?= site_cms_h($ctaCard['title'] ?? '') ?></strong>
                <span><?= site_cms_h($ctaCard['text'] ?? '') ?></span>
                <a href="<?= site_cms_h($ctaCard['link_href'] ?? '#') ?>" class="ct-cta-link"<?= str_starts_with((string) ($ctaCard['link_href'] ?? ''), 'http') ? ' target="_blank"' : '' ?>><?= site_cms_h($ctaCard['link_label'] ?? '') ?> <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
