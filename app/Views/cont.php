...
<head>
    ...
    besoiu_render_seo_meta(besoiu_seo_page_meta('/cont', [
        'title' => ($isLoggedIn ? 'Contul meu' : 'Autentificare') . ' — Besoiu Piese Auto',
        'description' => 'Cont personal Besoiu Piese Auto — autentificare, înregistrare, comenzi și date de livrare.',
        'noindex' => true,
    ]));
    ?>
        ...
        <div class="ac-layout">
            <aside class="ac-sidebar">
                ...
                <nav class="ac-nav" aria-label="Meniu cont">
                    <button type="button" class="ac-nav-link<?= $view === 'dashboard' ? ' active' : '' ?>" data-view="dashboard"><i class="fa-solid fa-house" aria-hidden="true"></i> Panou principal</button>
                    <button type="button" class="ac-nav-link<?= $view === 'orders' ? ' active' : '' ?>" data-view="orders"><i class="fa-solid fa-clock-rotate-left" aria-hidden="true"></i> Istoric comenzi</button>
                    <button type="button" class="ac-nav-link<?= $view === 'addresses' ? ' active' : '' ?>" data-view="addresses"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Adresele mele</button>
                    <button type="button" class="ac-nav-link<?= $view === 'profile' ? ' active' : '' ?>" data-view="profile"><i class="fa-solid fa-user" aria-hidden="true"></i> Date cont</button>
                    <span class="ac-nav-link ac-nav-soon" title="În curând"><i class="fa-solid fa-bell" aria-hidden="true"></i> Notificări</span>
                    <button type="button" class="ac-nav-link<?= $view === 'favorites' ? ' active' : '' ?>" data-view="favorites"><i class="fa-solid fa-heart" aria-hidden="true"></i> Lista favorite</button>
                    <span class="ac-nav-link ac-nav-soon" title="În curând"><i class="fa-solid fa-star" aria-hidden="true"></i> Recenzii</span>
                    <button type="button" class="ac-nav-link<?= $view === 'security' ? ' active' : '' ?>" data-view="security"><i class="fa-solid fa-lock" aria-hidden="true"></i> Securitate</button>
                    <button type="button" class="ac-nav-link ac-nav-logout" data-ac-logout><i class="fa-solid fa-right-from-bracket" aria-hidden="true"></i> Deconectare</button>
                </nav>
            </aside>
                ...
                <section class="ac-panel ac-dash ac-card<?= $view === 'dashboard' ? ' active' : '' ?>" data-view="dashboard"
                    ...
                    <div class="ac-dash-hero">
                        ...
                        <div class="ac-dash-hero-visual">
                            <img src="<?= shop_auth_h($heroCarImage) ?>" alt="Automobil — Besoiu Piese Auto" loading="eager" decoding="async" onerror="this.onerror=null;this.src='<?= shop_auth_h($heroCarFallback) ?>';">
                        </div>
                    </div>
                    ...
                    <div class="ac-dash-body">
                        <div class="ac-dash-kpis">
                            <div class="ac-kpi ac-kpi--green">
                                <div class="ac-kpi-top">
                                    <div class="ac-kpi-icon"><i class="fa-solid fa-box" aria-hidden="true"></i></div>
                            ...
                            <div class="ac-kpi ac-kpi--blue">
                                <div class="ac-kpi-top">
                                    <div class="ac-kpi-icon"><i class="fa-solid fa-spinner" aria-hidden="true"></i></div>
                            ...
                            <div class="ac-kpi ac-kpi--teal">
                                <div class="ac-kpi-top">
                                    <div class="ac-kpi-icon"><i class="fa-solid fa-truck" aria-hidden="true"></i></div>
                            ...
                            <div class="ac-kpi ac-kpi--violet">
                                <div class="ac-kpi-top">
                                    <div class="ac-kpi-icon"><i class="fa-solid fa-wallet" aria-hidden="true"></i></div>
                        ...
                        <div class="ac-dash-main-row">
                            <div class="ac-dash-block">
                                ...
                                <div class="ac-dash-block-body" id="ac-dash-last-order">
                                    <div class="ac-dash-empty"><i class="fa-solid fa-spinner fa-spin" aria-hidden="true"></i> Se încarcă...</div>
                                </div>
                            </div>
                            ...
                            <div class="ac-dash-block">
                                ...
                                <div class="ac-dash-block-body">
                                    <div class="ac-dash-profile-row"><i class="fa-solid fa-user" aria-hidden="true"></i><span><?= shop_auth_h($customer['name']) ?></span></div>
                                    <div class="ac-dash-profile-row"><i class="fa-solid fa-envelope" aria-hidden="true"></i><span><?= shop_auth_h($customer['email']) ?></span></div>
                                    <div class="ac-dash-profile-row"><i class="fa-solid fa-phone" aria-hidden="true"></i><span id="ac-dash-phone"><?= $customer['phone'] !== '' ? shop_auth_h($customer['phone']) : 'Necompletat' ?></span></div>
                        ...
                        <div class="ac-dash-help-bar">
                            ...
                            <div class="ac-dash-help-actions">
                                <a href="<?= site_cms_h($dashPhoneHref) ?>" class="ac-dash-help-btn"><i class="fa-solid fa-phone" aria-hidden="true"></i> <?= site_cms_h($dashPhone) ?></a>
                                <a href="/contact" class="ac-dash-help-btn"><i class="fa-solid fa-envelope" aria-hidden="true"></i> Contact</a>
                                <a href="/catalog" class="ac-dash-help-btn"><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i> Catalog</a>
                            </div>
                        </div>

                        <div class="ac-dash-quick-row">
                            <button type="button" class="ac-quick-pill" data-view="orders"><i class="fa-solid fa-box" aria-hidden="true"></i> Urmărește comanda</button>
                            <button type="button" class="ac-quick-pill" data-view="orders"><i class="fa-solid fa-clock-rotate-left" aria-hidden="true"></i> Istoric comenzi</button>
                            <button type="button" class="ac-quick-pill" data-view="addresses"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Adresele mele</button>
                            <button type="button" class="ac-quick-pill" data-view="security"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i> Securitate cont</button>
                        </div>
                    </div>
                </section>
