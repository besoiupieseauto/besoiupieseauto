...
<head>
    ...
    besoiu_render_seo_meta(besoiu_seo_page_meta('/cart', [
        'title' => 'Coș de cumpărături — Besoiu Piese Auto',
        'description' => 'Finalizează comanda de piese auto.',
        'noindex' => true,
    ]));
    ?>
        ...
        <div class="container">
            ...
            <div class="stepper" id="checkout-stepper" aria-label="Pași finalizare comandă">
                <div class="step active" data-checkout-step="1">
                    <div class="step-circle"><i class="fa-solid fa-check" aria-hidden="true"></i></div>
            ...
            <div class="checkout-success is-hidden" id="checkout-success-panel" role="status" aria-live="polite">
                <div class="checkout-success-icon"><i class="fa-solid fa-circle-check" aria-hidden="true"></i></div>
                    ...
                    <div class="products-card">
                        ...
                        <div class="cart-items-list" id="cart-items-list">
                            <div class="cart-loading">
                                <div class="cart-loading-icon"><i class="fa-solid fa-cart-shopping" aria-hidden="true"></i></div>
                        ...
                        <div class="cart-continue-wrap is-hidden" id="cart-continue-wrap">
                            <button type="button" class="btn-continue-checkout" id="btn-continue-checkout">
                                Continuă la finalizare <i class="fa-solid fa-arrow-down" aria-hidden="true"></i>
                            </button>
                        </div>

                        <div class="coupon-bar">
                            <div class="coupon-wrap">
                                <label for="cart-coupon-code" class="visually-hidden">Cod promoțional</label>
                                <input type="text" id="cart-coupon-code" placeholder="Introdu codul promoțional..." aria-label="Cod promoțional">
                                <button type="button" id="cart-coupon-apply" aria-label="Aplică codul promoțional">APLICĂ</button>
                            </div>
                ...
                <aside class="cart-sidebar" id="checkout-panel">
                    <div class="summary-card">
                        <div class="summary-top">
                            <h3>Sumar comandă</h3>
                            <div class="summary-top-icon"><i class="fa-solid fa-bag-shopping" aria-hidden="true"></i></div>
                        </div>
                        <div class="summary-body">
                            <table class="table-totals">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><i class="fa-solid fa-truck summary-label-icon" aria-hidden="true"></i>Livrare</td>
                                        <td>Gratuit</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                            ...
                            <div class="delivery-title"><i class="fa-solid fa-box" aria-hidden="true"></i> Metoda de livrare</div>
                            ...
                            <div class="delivery-grid">
                                <label class="delivery-opt active" data-ship="ridicare_locala">
                                    ...
                                    <span class="d-icon"><i class="fa-solid fa-store" aria-hidden="true"></i></span>
                                    <span>
                                ...
                                <label class="delivery-opt" data-ship="tarif_fix">
                                    ...
                                    <span class="d-radio"></span>
                                    <span class="d-icon"><i class="fa-solid fa-truck-fast" aria-hidden="true"></i></span>
                                    <span>
                            ...
                            <div class="delivery-title"><i class="fa-solid fa-credit-card" aria-hidden="true"></i> Metoda de plată</div>
                            <div class="payment-grid" id="payment-methods-grid"></div>

                            <form id="cart-shipping-form" onsubmit="return false;">
                                <div class="client-title"><i class="fa-solid fa-address-card" aria-hidden="true"></i> Date livrare</div>
                            ...
                            <button type="button" class="btn-checkout" data-cart-submit-order>
                                FINALIZEAZĂ COMANDA <i class="fa-solid fa-arrow-right" aria-hidden="true"></i>
                            </button>

                            <div class="trust-badges">
                                <span class="trust-badge"><i class="fa-solid fa-lock" aria-hidden="true"></i> Plată securizată</span>
                                <span class="trust-badge"><i class="fa-solid fa-rotate-left" aria-hidden="true"></i> Retur 14 zile</span>
                                <span class="trust-badge"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i> Garanție</span>
                            </div>
                        </div>
                    </div>
                </aside>
