...
require_once BESOIU_LEGACY . '/note-html.php';
require_once BESOIU_LEGACY . '/tecdoc_description.php';
...
if (!$productPageImages) {
    $productPageImages = [besoiu_default_product_image()];
}
...
<head>
    ...
    $productSeoImage = $productPageImages[0] ?? '/assets/img/logo.png';
    besoiu_render_seo_meta(besoiu_seo_page_meta(
        '/produs?id=' . rawurlencode((string) ($productPageId ?? '')),
        [
            'title' => $productPageName . ' | Besoiu Piese Auto',
            'description' => $productPageDescriptionPlain,
    ...
    <?php
    besoiu_link_external_stylesheet('https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css', true);
    besoiu_link_external_stylesheet('https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css', true);
    ?>
...
<div class="page">
    ...
    <main id="main-content">
        <div class="container">
            ...
            <div class="prod-layout">
                ...
                <div class="prod-gallery">
                    <div class="prod-gallery-main">
                        ...
                        <div class="gallery-actions">
                            <button type="button" id="prod-share-btn" class="prod-share-btn" aria-label="Distribuie produsul" data-share-url="<?= product_page_h($productPageAbsoluteUrl) ?>" data-share-title="<?= product_page_h($productPageName) ?>"><i class="fa-solid fa-share-nodes" aria-hidden="true"></i></button>
                            <button type="button" id="prod-fav-btn" class="prod-fav-btn" aria-label="Adaugă la favorite" aria-pressed="false" data-product-id="<?= product_page_h($productPageId) ?>"><i class="fa-regular fa-heart" aria-hidden="true"></i></button>
                        </div>
                ...
                <div class="prod-details product-single-details"
                    ...
                    <ul class="prod-specs-list">
                        <li>
                            <span class="spec-icon"><i class="fa-solid fa-barcode" aria-hidden="true"></i></span>
                            <span class="spec-label">Cod produs</span>
                            <span class="spec-value"><?= product_page_h($productPageCode !== '' ? $productPageCode : 'N/A') ?></span>
                        </li>
                        <li>
                            <span class="spec-icon"><i class="fa-solid fa-industry" aria-hidden="true"></i></span>
                        ...
                        <li>
                            <span class="spec-icon"><i class="fa-solid fa-folder-open" aria-hidden="true"></i></span>
                            <span class="spec-label">Categorie</span>
                            <span class="spec-value"><?= product_page_h($productPageCategory) ?></span>
                        </li>
                        <li>
                            <span class="spec-icon"><i class="fa-solid fa-car" aria-hidden="true"></i></span>
                    ...
                    <div class="prod-action">
                        <div class="qty-stepper">
                            <button type="button" class="qty-minus" aria-label="Scade cantitatea"><i class="fa-solid fa-minus" aria-hidden="true"></i></button>
                            <label for="prod-quantity-input" class="visually-hidden">Cantitate</label>
                            <input type="number" id="prod-quantity-input" class="horizontal-quantity" placeholder="1" min="1" max="99" aria-label="Cantitate produs">
                            <button type="button" class="qty-plus" aria-label="Crește cantitatea"><i class="fa-solid fa-plus" aria-hidden="true"></i></button>
                        </div>
                        <button class="prod-add-cart add-cart" type="button" aria-label="Adaugă produsul în coș">
                    ...
                    <div class="trust-badges">
                        <div class="badge-card">
                            <div class="badge-icon"><i class="fa-solid fa-truck-fast" aria-hidden="true"></i></div>
                            Livrare 24h
                        </div>
                        <div class="badge-card">
                            <div class="badge-icon"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i></div>
                            Garanție 90 zile
                        </div>
                        <div class="badge-card">
                            <div class="badge-icon"><i class="fa-solid fa-rotate-left" aria-hidden="true"></i></div>
                            Retur 14 zile
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content" id="productTabsContent">
                    ...
                    <div class="tab-pane fade" id="product-reviews-content" role="tabpanel" aria-labelledby="product-tab-reviews">
                        <div class="review-card">
                            <img src="assets/images/blog/author.jpg" alt="Poză client — recenzie verificată" width="56" height="56" loading="lazy">
                            <div>
                                <div class="review-stars"><i class="fa-solid fa-star" aria-hidden="true"></i><i class="fa-solid fa-star" aria-hidden="true"></i><i class="fa-solid fa-star" aria-hidden="true"></i><i class="fa-solid fa-star" aria-hidden="true"></i><i class="fa-solid fa-star" aria-hidden="true"></i></div>
            ...
            <section class="related-section" id="related-products" data-recommendation-slot="related">
                ...
                <div class="related-grid">
                    <?php foreach ($productPageRelated as $relatedItem):
                        ...
                        $relatedImage = $relatedImages[0] ?? besoiu_default_product_image();
                    ?>
                    <a href="/produs?id=<?= product_page_h($relatedId) ?>" class="related-card" data-product-id="<?= product_page_h($relatedId) ?>">
                        <div class="card-img">
...
<script>
(function () {
  if (!document.querySelector('.product-single-carousel')) return;
  ...
  loadScript('https://code.jquery.com/jquery-3.7.1.min.js', function () {
    loadScript('https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js', function () {
      loadScript('<?= besoiu_asset_href('assets/js/product-carousel.js') ?>');
    });
  });
  loadScript('https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js');
})();
</script>
<?php besoiu_render_scripts('product'); ?>
