...
<head>
    ...
    besoiu_render_seo_meta(besoiu_seo_page_meta('/despre', $aboutPage, 'website'));
    ?>
    ...
    <div class="ab-hero-right">
        <div class="ab-hero-visual">
            <div class="ab-photo-main">
                <img src="<?= about_h($aboutHeroMain) ?>" alt="Automobil — Besoiu Piese Auto" loading="eager" fetchpriority="high" decoding="async" onerror="this.onerror=null;this.src='<?= about_h($aboutHeroFallback) ?>';">
            </div>
            <div class="ab-photo-sm one">
                <img src="<?= about_h($aboutHeroSmOne) ?>" alt="Piese auto" loading="eager" decoding="async" onerror="this.onerror=null;this.src='<?= about_h($aboutHeroFallback) ?>';">
            </div>
            <div class="ab-photo-sm two">
                <img src="<?= about_h($aboutHeroSmTwo) ?>" alt="Service auto" loading="eager" decoding="async" onerror="this.onerror=null;this.src='<?= about_h($aboutHeroFallback) ?>';">
            </div>
        </div>
    </div>
</section>
...
<div class="ab-stats">
    ...
    <div class="ab-stat">
        <div class="ab-stat-icon"><i class="fa-solid <?= about_h($stat['icon'] ?? 'fa-star') ?>" aria-hidden="true"></i></div>
        <div class="ab-stat-num"><?= about_h($stat['value'] ?? '') ?><?php if (!empty($stat['suffix_icon'])): ?><i class="fa-solid <?= about_h($stat['suffix_icon']) ?>" style="font-size:.65em;margin-left:2px;" aria-hidden="true"></i><?php endif; ?></div>
    ...
    <div class="container">
        ...
        <div class="ab-why-grid">
            ...
            <div class="ab-why-card">
                <div class="ab-why-icon"><i class="fa-solid <?= about_h($whyCard['icon'] ?? 'fa-check') ?>" aria-hidden="true"></i></div>
    ...
    <div class="container">
        <div class="ab-cta-inner">
            ...
            <div class="ab-cta-btns">
                <a href="<?= about_h($aboutCtaHref) ?>" class="ab-btn-green"><i class="fa-solid fa-phone" aria-hidden="true"></i> <?= about_h($aboutCtaPhone) ?></a>
                <a href="<?= about_h($aboutPage['cta']['secondary']['href'] ?? 'catalog.php') ?>" class="ab-btn-outline"><?= about_h($aboutPage['cta']['secondary']['label'] ?? 'Vezi catalogul') ?> <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
</section>
