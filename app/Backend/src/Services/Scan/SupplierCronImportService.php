...
final class SupplierCronImportService
{
    ...
    public function __construct(
        private readonly ?object $feed = null,
        private readonly ?object $stats = null,
    ) {
    }
    ...
    {
        \Besoiu\Services\Import\ImportLibLoader::bootForCron();
    }

    private function feed(): object
    {
        $service = $this->feed ?? SupplierHooks::feed();
        if ($service === null) {
    ...
    {
        return $this->stats ?? SupplierHooks::stats();
    }
}
