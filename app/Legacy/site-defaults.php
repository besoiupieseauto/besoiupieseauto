...
if (!function_exists('site_defaults_blocks')) {
    function site_defaults_blocks(string $slug): array
    {
        return match ($slug) {
            'home' => [
                ...
                'products' => [
                    ...
                    'trust' => [
                        ...
                        ['title' => 'Suport telefonic', 'subtitle' => besoiu_store_phone_display(), 'subtitle_href' => besoiu_store_phone_tel(), 'icon' => 'img/icons/27_casti_suport.svg'],
                    ],
                ],
                'brands' => [
                ...
                'why' => [
                    ...
                    'phone_href' => besoiu_store_phone_tel(),
                    ...
                    'car_image' => 'assets/img/car1.webp',
                ],
            ],
            'global' => [
                'topbar' => [
            ...
            'contact' => [
                'strip' => [
                    ['icon' => 'fa-location-dot', 'title' => besoiu_store_address_short(), 'subtitle' => '300162 Timișoara, România'],
                    ['icon' => 'fa-phone', 'title' => besoiu_store_phone_display(), 'subtitle' => 'Luni – Vineri'],
                ...
                'float_cards' => [
                    ['icon' => 'fa-phone', 'title' => besoiu_store_phone_display(), 'subtitle' => 'Sună acum'],
                    ['icon' => 'fa-envelope', 'title' => 'contact@besoiupieseauto.ro', 'subtitle' => 'Email'],
                    ['icon' => 'fa-location-dot', 'title' => 'Timișoara, România', 'subtitle' => besoiu_store_address_short()],
                ],
                'form' => [
                ...
                'cta' => [
                    ...
                    'cards' => [
                        ['icon' => 'fa-phone', 'title' => 'Telefonic', 'text' => 'Sună la ' . besoiu_store_phone_display(), 'link_label' => 'Sună acum', 'link_href' => besoiu_store_phone_tel()],
                        ...
                        ['icon' => 'fa-location-dot', 'title' => 'Vizitează-ne', 'text' => besoiu_store_address_line(), 'link_label' => 'Vezi pe hartă', 'link_href' => besoiu_store_maps_url()],
                    ],
                ],
            ],
            default => [],
