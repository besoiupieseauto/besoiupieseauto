...
<head>
    ...
    <?php endif; ?>
    <?php
    require_once __DIR__ . '/besoiu-seo.php';
    $staticPathMap = [
        'contact' => '/contact',
        'about' => '/despre',
        'blog' => '/blog',
    ...
    $seoPath = $staticPathMap[$slug] ?? ('/p/' . $slug);
    besoiu_render_seo_meta(besoiu_seo_page_meta($seoPath, [
        'title' => $title . ' — Besoiu Piese Auto',
    ...
    <div class="container <?= static_page_h($layoutClass) ?>">
        ...
        <aside class="sp-sidebar">
            ...
            <div class="sp-side-box sp-side-contact">
                ...
                <ul>
                    <li><span class="site-icon site-icon--sm"><i class="fa-solid fa-phone" aria-hidden="true"></i></span> <a href="<?= static_page_h(besoiu_store_phone_tel()) ?>"><?= static_page_h(besoiu_store_phone_display()) ?></a></li>
                    <li><span class="site-icon site-icon--sm"><i class="fa-solid fa-envelope" aria-hidden="true"></i></span> <a href="mailto:contact@besoiupieseauto.ro">contact@besoiupieseauto.ro</a></li>
                    <li><span class="site-icon site-icon--sm"><i class="fa-solid fa-location-dot" aria-hidden="true"></i></span> <?= static_page_h(besoiu_store_address_line()) ?></li>
                </ul>
