...
/** Fallback CORE — acces DB cand modulul furnizori lipseste sau e dezactivat (import/scan). * Acces la tabela `furnizori`.
 */
final class SupplierCatalogRepositoryFallback
{
