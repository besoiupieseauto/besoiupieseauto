...
(function () {
  ...
  function closeModal(el) {
    ...
    // Modale importreview: doar clase — evită inline display:!important care blochează deschiderea
    if (el.id === 'importQueueEditModal' || el.id === 'importQueuePreviewModal') {
