...
<link rel="stylesheet" href="<?= produse_list_h(AdminUrl::publicAsset('css/admin-produse-formare.css')) ?>?v=20260721-pcf-inputs1">
...
<div class="admin-panel">
    ...
    <?php include __DIR__ . '/_produse-section-nav.php'; ?>
