<style>
  .furnizori-page { --fz-primary: #14b8a6; --fz-primary-dark: #0f766e; --fz-border: #e5e7eb; --fz-muted: #64748b; --fz-success: #16a34a; --fz-danger: #dc2626; --fz-warning: #d97706; --fz-surface: #f3fbf8; --fz-ink: #134e4a; }
  .furnizori-page .fz-blocked-freeze-bar {
    display: none;
    margin-top: 16px;
    padding: 14px 16px;
    border-radius: 12px;
  ...
  .furnizori-page .fz-blocked-freeze-bar.is-visible { display: block; }
  .furnizori-page .fz-blocked-freeze-bar strong { color: #7f1d1d; }
  .furnizori-page .fz-card-freeze-note {
    margin-top: 8px;
    padding: 8px 10px;
    border-radius: 8px;
    background: #fef2f2;
  ...
  .furnizori-page .fz-btn-price {
    ...
    border-radius: 10px; border: 1.5px solid #99f6e4; background: #f0fdfa; color: #0f766e;
    font-size: 0.78rem; font-weight: 600; text-decoration: none !important; cursor: pointer; transition: all .15s;
  }
  .furnizori-page .fz-btn-price:hover { border-color: #14b8a6; background: #ccfbf1; color: #0a3d31; }
  ...
  .furnizori-page button.fz-btn-primary {
    ...
    border: none !important; background: #14b8a6 !important; color: #ffffff !important;
    font-size: 0.85rem; font-weight: 600; cursor: pointer;
    box-shadow: 0 2px 8px rgba(20,184,166,.35); transition: transform .15s, box-shadow .15s;
  }
  .furnizori-page .fz-btn-primary:hover { transform: translateY(-1px); background: #0f766e !important; color: #fff !important; box-shadow: 0 4px 14px rgba(20,184,166,.45); }
  ...
  .furnizori-page .fz-btn-outline:hover { border-color: #14b8a6 !important; color: #14b8a6 !important; background: #f0fdfa !important; }
  ...
  .furnizori-page .fz-search:focus { border-color: var(--fz-primary); box-shadow: 0 0 0 3px rgba(20,184,166,.12); background: #fff; }
  ...
  .furnizori-page .fz-card-conn-btn:hover { border-color: var(--fz-primary); color: var(--fz-primary); background: #f0fdfa; }
  .furnizori-page .fz-card-conn-btn--api { border-color: #99f6e4; background: #f0fdfa; color: #0f766e; }
  .furnizori-page .fz-card-conn-btn--api:hover { border-color: #14b8a6; background: #ccfbf1; color: #0a3d31; }
  ...
  .furnizori-page .fz-conn-panel--api {
    border-color: #99f6e4;
    background: linear-gradient(180deg, #f3fbf8 0%, #f0fdfa 100%);
  }
  ...
  .furnizori-page .fz-conn-panel--api .fz-conn-panel-badge { background: #ccfbf1; color: #0f766e; }
  ...
  .furnizori-page .fz-conn-btn:hover { border-color: var(--fz-primary); color: var(--fz-primary); background: #f0fdfa; }
  .furnizori-page .fz-conn-btn--primary {
    border-color: var(--fz-primary);
    background: var(--fz-primary);
    color: #fff;
  }
  .furnizori-page .fz-conn-btn--primary:hover { background: #0f766e; color: #fff; }
  ...
  .furnizori-page .fz-empty-icon { width: 56px; height: 56px; margin: 0 auto 16px; border-radius: 14px; background: #f0fdfa; display: flex; align-items: center; justify-content: center; color: var(--fz-primary); }
  .furnizori-page .fz-content-wrap { position: relative; min-height: 200px; }
  .furnizori-page .fz-content-wrap.is-loading .fz-grid,
  .furnizori-page .fz-content-wrap.is-loading #furnizori-pagination {
    opacity: 0.4; pointer-events: none; transition: opacity .2s ease;
  }
  .furnizori-page .fz-content-loader {
    display: none; position: absolute; inset: 0; z-index: 6;
    flex-direction: column; align-items: center; justify-content: center; gap: 14px;
    background: rgba(248, 250, 252, 0.72); border-radius: 14px;
  }
  .furnizori-page .fz-content-wrap.is-loading .fz-content-loader { display: flex; }
  .furnizori-page .fz-content-loader__spinner {
    width: 46px; height: 46px; border-radius: 50%;
    border: 3px solid rgba(20, 184, 166, 0.18); border-top-color: var(--fz-primary);
    animation: fz-spin .7s linear infinite;
  }
  .furnizori-page .fz-content-loader__text {
    margin: 0; font-size: 0.875rem; font-weight: 600; color: #475569;
  }
  .furnizori-page .fz-content-loader__dots::after {
    content: ''; animation: fz-dots 1.2s steps(4, end) infinite;
  }
  ...
  .furnizori-page .fz-skeleton-grid {
    display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 18px; margin-top: 20px;
  }
  .furnizori-page .fz-content-wrap.is-loading .fz-skeleton-grid { display: grid; }
  .furnizori-page .fz-content-wrap:not(.is-loading) .fz-skeleton-grid { display: none; }
  .furnizori-page .fz-content-wrap.is-loading .fz-grid { display: none; }
  .furnizori-page .fz-skeleton-card {
    height: 220px; border-radius: 14px; border: 1px solid var(--fz-border); background: #fff;
    overflow: hidden; position: relative;
  }
  .furnizori-page .fz-skeleton-card::after {
    content: ''; position: absolute; inset: 0;
    background: linear-gradient(90deg, transparent, rgba(20, 184, 166, 0.06), transparent);
    transform: translateX(-100%); animation: fz-shimmer 1.4s ease-in-out infinite;
  }
  @keyframes fz-shimmer { 100% { transform: translateX(100%); } }
  ...
  #furnizori-modal .fz-modal-btn-save:hover {
    ...
    background-image: linear-gradient(135deg, #0f766e 0%, #0a3d31 100%) !important;
    color: #ffffff !important;
  ...
  #furnizori-conn-modal .fz-conn-panel--api {
    border-color: #99f6e4; background: linear-gradient(180deg, #f3fbf8 0%, #f0fdfa 100%);
  }
  ...
  #furnizori-conn-modal .fz-conn-panel--api .fz-conn-panel-badge { background: #ccfbf1; color: #0f766e; }
  ...
  #furnizori-conn-modal .fz-conn-field input:focus { outline: none; border-color: #14b8a6; box-shadow: 0 0 0 2px rgba(20,184,166,.12); }
  ...
  #furnizori-conn-modal .fz-conn-btn--primary { background: #14b8a6; border-color: #14b8a6; color: #fff; }
...
<div class="furnizori-page">
  ...
  <div class="fz-header">
    <div>
      <h2 class="fz-title" id="furnizori-page-title">Furnizori</h2>
      <p class="fz-subtitle" id="furnizori-page-subtitle">Gestionează furnizorii, compararea prețurilor și regulile de import.</p>
    </div>
  ...
  <div id="furnizori-blocked-freeze-bar" class="fz-blocked-freeze-bar" role="status">
    <strong>Freeze total</strong> — furnizorii de aici sunt opriți complet: fără import fișiere (Import Pro), fără comparare preț, fără scanare automată. Apasă „Deblochează” din meniul cardului când vrei să-i reactivezi.
  </div>
  ...
  <div class="fz-content-wrap is-loading" id="furnizori-content-wrap" aria-busy="true">
    <div class="fz-content-loader" id="furnizori-content-loader" role="status" aria-live="polite">
      <div class="fz-content-loader__spinner" aria-hidden="true"></div>
      <p class="fz-content-loader__text">Se încarcă furnizorii<span class="fz-content-loader__dots"></span></p>
    </div>
    <div class="fz-skeleton-grid" aria-hidden="true">
      <div class="fz-skeleton-card"></div>
      <div class="fz-skeleton-card"></div>
      <div class="fz-skeleton-card"></div>
    </div>
  ...
  <div class="fz-modal-dialog" role="document">
    ...
    <form id="furnizori-form" data-action="add">
      ...
      <div class="fz-modal-foot">
        ...
        <button type="submit" class="fz-modal-btn-save" style="background:#14b8a6;color:#fff;border:none;">Salvează furnizorul</button>
      </div>
    </form>
  </div>
</div>
...
const contentWrap=document.getElementById('furnizori-content-wrap');

function setContentLoading(on){
  if(!contentWrap) return;
  contentWrap.classList.toggle('is-loading',!!on);
  contentWrap.setAttribute('aria-busy',on?'true':'false');
}
    ...
    return`<article class="fz-card ${blocked?'is-blocked':''}" data-id="${escapeHtml(sid)}">
      <div class="fz-card-head ${blocked?'is-blocked':''}">
        ...
        <div class="fz-card-head-content">
          ...
          ${blocked?'<div class="fz-card-freeze-note">Blocat — fără import, comparare sau scanare până la deblocare.</div>':''}
        </div>
      </div>
...
async function load(page){
  ...
  try{
    ...
    if(reqId===loadRequestId) setContentLoading(false);
  }
}
...
async function handleSupplierAction(btn,card){
  ...
  try{
    ...
    if(btn.dataset.action==='toggle'){
      ...
      showToast(wasActive
        ? 'Furnizor blocat — freeze total (Import Pro, comparare, scanare).'
        : 'Furnizor deblocat — poate importa și compara din nou.',false);
      closeConnModal();
...
const PAGE_COPY={
  compare:{title:'Comparare furnizori',subtitle:'Configurează în 4 pași cine câștigă la același cod produs: prioritate, excluderi, reguli preț și stoc zero.'},
  lista:{title:'Lista furnizori',subtitle:'Vezi, adaugă și configurează conexiunile fiecărui furnizor.'},
  blocked:{title:'Furnizori blocați',subtitle:'Freeze total: nu importă, nu compară, nu scanează — până îi deblochezi explicit.'}
};
function updateBlockedFreezeBar(tabId){
  const bar=document.getElementById('furnizori-blocked-freeze-bar');
  if(bar) bar.classList.toggle('is-visible', tabId==='blocked');
}
function updatePageHeader(tabId){
  const copy=PAGE_COPY[tabId]||PAGE_COPY.lista;
  const titleEl=document.getElementById('furnizori-page-title');
  const subEl=document.getElementById('furnizori-page-subtitle');
  if(titleEl) titleEl.textContent=copy.title;
  if(subEl) subEl.textContent=copy.subtitle;
  updateBlockedFreezeBar(tabId);
}
