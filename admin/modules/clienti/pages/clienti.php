<div>
    ...
    <div
        ...
        aria-hidden="true"
        role="dialog"
        aria-labelledby="clienti-modal-title"
    >
        <div class="besoiu-modal besoiu-modal--lg" role="document">
            <div class="besoiu-modal__head">
                <h3 id="clienti-modal-title">Client nou</h3>
                <button type="button" id="clienti-close-modal" class="besoiu-modal__close" aria-label="Închide">×</button>
            </div>

            <form id="clienti-form" class="besoiu-modal__body" data-clienti-form data-action="add">
                ...
                <div class="grid grid-cols-12 gap-4">
                    <label class="col-span-12 md:col-span-6 besoiu-modal__field">
                        ...
                        <input type="text" name="client_name" required maxlength="160">
                    </label>
                    ...
                    <label class="col-span-12 md:col-span-4 besoiu-modal__field">
                        <span>Comenzi</span>
                        <input type="number" name="total_orders" min="0" value="0">
                    </label>

                    <label class="col-span-12 md:col-span-4 besoiu-modal__field">
                        <span>Total plătit</span>
                        <input type="number" name="total_paid" min="0" step="0.01" value="0.00">
                    </label>

                    <label class="col-span-12 besoiu-modal__field">
                        <span>Curier preferat</span>
                        <input type="text" name="preferred_courier" maxlength="120" placeholder="Fan Courier, GLS…">
                    </label>
                ...
                <div class="besoiu-modal__foot">
                    <button type="button" id="clienti-cancel" class="besoiu-btn-secondary">Anulează</button>
...
(function () {
  ...
  function renderClients() {
    if (!tableBody) return;
    if (counter) {
      counter.textContent = `${listMeta.total} clienți`;
  ...
  function bootClients() {
    if (tableBody) {
      tableBody.innerHTML = '<tr><td colspan="6" class="box bg-background p-6 text-center opacity-70">Se incarca...</td></tr>';
    }
    loadClients().catch((error) => showToast(error.message, true));
  }

  if (window.BpaAsync && typeof window.BpaAsync.defer === 'function') {
    BpaAsync.defer(bootClients);
