-- ============================================================
-- MIGRARE: Modul Furnizori in Admin
-- Tabela + rute pentru lista si profil furnizor
-- ============================================================
...
SELECT 'GET', '/admin/public/furnizori', 'Admin', 'index', 'loadPage', '/admin/Templates/admin/pages/furnizori/', 1
WHERE NOT EXISTS (
    SELECT 1 FROM `routes` WHERE `method` = 'GET' AND `path` = '/admin/public/furnizori'
);

INSERT INTO `routes` (`method`, `path`, `controller`, `action`, `load_type`, `dir`, `is_active`)
SELECT 'GET', '/admin/public/profilefurnizori', 'Admin', 'index', 'loadPage', '/admin/Templates/admin/pages/furnizori/', 1
WHERE NOT EXISTS (
    SELECT 1 FROM `routes` WHERE `method` = 'GET' AND `path` = '/admin/public/profilefurnizori'
);

INSERT INTO `routes` (`method`, `path`, `controller`, `action`, `load_type`, `dir`, `is_active`)
SELECT 'GET', '/admin/public/addfurnizori', 'Admin', 'index', 'loadPage', '/admin/Templates/admin/pages/furnizori/', 1
WHERE NOT EXISTS (
    SELECT 1 FROM `routes` WHERE `method` = 'GET' AND `path` = '/admin/public/addfurnizori'
);
