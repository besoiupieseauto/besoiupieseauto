...
.scraper-page .sc-veh-panel { border: 1px solid #e2e8f0; border-radius: 10px; padding: 14px; background: #f8fafc; }
.scraper-page .sc-veh-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 12px; margin-bottom: 12px; }
@media (max-width: 768px) { .scraper-page .sc-veh-grid { grid-template-columns: 1fr; } }
.scraper-page .sc-veh-actions { display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 10px; }
.scraper-page .sc-veh-out {
    margin: 0; font-size: 0.72rem; line-height: 1.45; max-height: 220px; overflow: auto;
    background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 10px;
    white-space: pre-wrap; word-break: break-word;
}
.scraper-page .sc-veh-combo-table { width: 100%; border-collapse: collapse; font-size: 0.78rem; margin-top: 8px; }
.scraper-page .sc-veh-combo-table th, .scraper-page .sc-veh-combo-table td {
    border: 1px solid #e2e8f0; padding: 6px 8px; text-align: left; vertical-align: top;
}
.scraper-page .sc-veh-combo-table th { background: #f1f5f9; font-weight: 600; }
.scraper-page .sc-veh-progress { margin-bottom: 10px; }
.scraper-page .sc-veh-progress-head { display: flex; justify-content: space-between; font-size: 0.78rem; font-weight: 600; margin-bottom: 6px; color: #0f172a; }
.scraper-page .sc-veh-progress-pct { color: #0d9488; }
.scraper-page .sc-veh-progress.is-running .sc-pipeline-bar-fill { animation: none; }
